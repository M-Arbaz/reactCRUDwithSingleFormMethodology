  ...
  return (
    <>
      ...
      <form onSubmit={submit} autoComplete="off" encType="multipart/form-data" >
        <input type="text" value={i} name="id" placeholder="Enter Id here"/>
        <br/>
        <input type="text" value={name} onChange={(e)=>{setname(e.target.value)}} name="name" placeholder="Enter Name here"/>
        <br/>
        <input type="text" name="jd" value={jd} onChange={(e)=>{setjd(e.target.value)}} placeholder="Enter Job description" />
        <br/>
